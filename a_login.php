...
$query_noy_rec_admin = "SELECT * FROM noy_admin";
$noy_rec_admin = mysql_query($query_noy_rec_admin, $mysqli) or die(mysql_error());
$row_noy_rec_admin = mysql_fetch_assoc($noy_rec_admin);
$totalRows_noy_rec_admin = mysql_num_rows($noy_rec_admin);
?>
<?php
...
<div class="btn btn-info text-white w-100 mt-4"></div>
      </div>
    </div>
...
<?php
mysql_free_result($noy_rec_admin);
?>
